...
SERVICE_DIR="${ROOT}/services/message-delivery"
IMAGE="${IMAGE:-message-delivery:latest}"
LOAD_KIND=false
NO_CACHE=""
...
Build the message-delivery production image.

Options:
  -t, --tag TAG     Image tag (default: message-delivery:latest)
...
Examples:
  $(basename "$0")
  $(basename "$0") -t message-delivery:latest
