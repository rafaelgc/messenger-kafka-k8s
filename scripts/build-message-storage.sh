...
SERVICE_DIR="${ROOT}/services/message-storage"
IMAGE="${IMAGE:-message-storage:latest}"
LOAD_KIND=false
NO_CACHE=""
...
Build the message-storage production image.

Options:
  -t, --tag TAG     Image tag (default: message-storage:latest)
...
Examples:
  $(basename "$0")
  $(basename "$0") -t message-storage-image:latest
